// Generated by gencpp from file ins_interface/HNR_PVT.msg
// DO NOT EDIT!


#ifndef INS_INTERFACE_MESSAGE_HNR_PVT_H
#define INS_INTERFACE_MESSAGE_HNR_PVT_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::ins_interface::HNR_PVT_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::ins_interface::HNR_PVT_<ContainerAllocator> const> ConstPtr;

}; // struct HNR_PVT_

typedef ::ins_interface::HNR_PVT_<std::allocator<void> > HNR_PVT;

typedef boost::shared_ptr< ::ins_interface::HNR_PVT > HNR_PVTPtr;
typedef boost::shared_ptr< ::ins_interface::HNR_PVT const> HNR_PVTConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::ins_interface::HNR_PVT_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::ins_interface::HNR_PVT_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::ins_interface::HNR_PVT_<ContainerAllocator1> & lhs, const ::ins_interface::HNR_PVT_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::ins_interface::HNR_PVT_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ins_interface::HNR_PVT_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ins_interface::HNR_PVT_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ins_interface::HNR_PVT_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ins_interface::HNR_PVT_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ins_interface::HNR_PVT_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::ins_interface::HNR_PVT_<ContainerAllocator> >
{
  ...
  static const char* value(const ::ins_interface::HNR_PVT_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xd33eab200001ff2dULL;
  static const uint64_t static_value2 = 0x862a768edf2ace25ULL;
};

template<class ContainerAllocator>
struct DataType< ::ins_interface::HNR_PVT_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::ins_interface::HNR_PVT_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::ins_interface::HNR_PVT_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::ins_interface::HNR_PVT_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ins_interface::HNR_PVT_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // INS_INTERFACE_MESSAGE_HNR_PVT_H
